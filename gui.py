...
class_type = StringVar()
class_type_combo = ttk.Combobox(window, textvariable=class_type, state="readonly")
class_type_combo['values'] = ('單一課表', '混合課表')
class_type_combo.current(0)
class_type_combo.pack()
